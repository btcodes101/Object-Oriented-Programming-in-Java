...
try{
        Triangle myTriangle2 = null;
        Triangle myTriangle1 = null;
     do {
...
// read user input
        ...
        break;
        case 5: 
            if(myTriangle1.compareTo(myTriangle2)==-1)   //purposely passing null to create an exception, ideally myTriangle2 should have been passed
